...
#import "VFLeftViewController.h"
#import "VFRightViewController.h"

@interface VFLeftViewController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@implementation VFLeftViewController
...
- (void)initHeader
{
    ...
    self.noteLabel.text = @"请将头向右倾斜15度如图";
...
//        [[NetManager sharedManager]requestLoadFaceWithData:jpegData name:[userDefaults valueForKey:@"employeeName"] employeeID:[userDefaults valueForKey:@"employeeID"] photoNumber:2 complete:^(id object, NSError *error) {
        VFRightViewController *right  = [[VFRightViewController alloc]init];
