...
#import "VFBottomViewController.h"

@interface VFTopViewController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@implementation VFTopViewController
...
- (void)initHeader
{
    ...
    self.noteLabel.text = @"请抬头向上倾斜15度如图";
    ...
    self.imageView.image = [UIImage imageNamed:@"top"];
...
//        [[NetManager sharedManager]requestLoadFaceWithData:jpegData name:[userDefaults valueForKey:@"employeeName"] employeeID:[userDefaults valueForKey:@"employeeID"] photoNumber:4 complete:^(id object, NSError *error) {
        VFBottomViewController *bottom = [[VFBottomViewController alloc]init];
