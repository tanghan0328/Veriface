...
@interface VFFrontViewController()<UIGestureRecognizerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@implementation VFFrontViewController
...
- (void)initAVCaptureSession{
    ...
    self.previewLayer.frame = CGRectMake(0, 144,SCREEN_WIDTH, SCREEN_HEIGHT-144);
