...
@interface VFBottomViewController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@implementation VFBottomViewController
...
//        [[NetManager sharedManager]requestLoadFaceWithData:jpegData name:[userDefaults valueForKey:@"employeeName"] employeeID:[userDefaults valueForKey:@"employeeID"] photoNumber:5 complete:^(id object, NSError *error) {
